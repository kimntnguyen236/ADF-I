...
public class ApartmentTest {
    ...
    public void display(int area){
        ...
        if(cnt==0){
           System.out.println("Hệ thống không tìm thấy căn hộ có diện tích lớn hơn "+area);
       }else{
           System.out.println("Hệ thống tìm thấy "+cnt+" sinh viên có điểm trung bình lớn hơn "+area);
       }
    }
    ...
    void menu(){        
        while(true){
            ...
            System.out.print("Vui lòng lựa chọn [1-6]: ");
