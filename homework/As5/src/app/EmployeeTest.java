...
//khai báo arraylist thì import gói thư viện java.util.ArrayList
public class EmployeeTest {
    ...
    public void menu(){
        while(true){
            ...
            System.out.print("Chọn các số theo mong muốn của bạn [1-5]: ");
            ...
            switch(opt){
                ...
                case "4":
                    String empName;
                    System.out.print("Nhập tên nhân viên cần kiếm: ");
