...
public class DemoJavaTime {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("9. Period");
            System.out.println("10. thoat");
            System.out.println("11. Temporal");
            System.out.print(" >> nhap chuc nang [1-11]: ");
            op = sc.nextLine().trim();
            switch (op) {
                case "1":
                    clock();
    ...
    static void duration() {
        ...
        Instant huy = Instant.parse("2000-05-20T12:25:30Z");
        System.out.printf("Tuoi cua Huy: %d ngay \n", Duration.between(huy, t2).toDays());
    ...
    static void localDate() {
        ...
        LocalDate huy = LocalDate.of(2001, 5, 20);
        System.out.println("Huy sinh ngay thu : "+huy.getDayOfWeek());
        }
    ...
    static void period(){
        ...
        LocalDate huy = LocalDate.of(2001, Month.MAY, 20);
        LocalDate snHuy = huy.withYear(d0.getYear());
        
        System.out.println("Sinh nhat nam nay cua Huy : "+snHuy);
        
        Period p = Period.between(d0, snHuy);
        System.out.printf("Con %d thang, %d ngay nua la sn Huy \n", p.getMonths(),p.getDays());
        
        long d = ChronoUnit.DAYS.between(d0, snHuy);
        System.out.printf("Tong cong la %d ngay a ! \n",d);
    }
    ...
    static void temporal(){
        ...
        LocalDate d1 = LocalDate.of(today.getYear(), today.getMonth().plus(1),1);
        //lấy ngày thứ hai (Monday) đầu tiên của tháng
        LocalDate d2 = d1.with(TemporalAdjusters.nextOrSame(DayOfWeek.MONDAY));
        System.out.printf("Ngay thu 2 (Monday) dau tien cua thang %s : %s \n",d2.getMonth(),d2.format(DateTimeFormatter.ISO_DATE));
    }
}
