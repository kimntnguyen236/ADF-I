...
public class TestEncoding {
    ...
    public static void main(String[] args) {
        try {
            String s = "AptechJava8";
            System.out.println("Original text: "+s);
// Encoding a string using Base64
            String sEncode = Base64.getEncoder().encodeToString("AptechJava8".getBytes("utf-8"));
...
// Decoding a string using Base64
            ...
            sEncode = Base64.getUrlEncoder().encodeToString("AptechJava8".getBytes("utf-8"));
